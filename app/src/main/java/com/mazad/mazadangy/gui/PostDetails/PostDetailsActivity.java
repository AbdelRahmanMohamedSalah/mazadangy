...
import com.mazad.mazadangy.adapter.MySliderAdapter;
import com.mazad.mazadangy.gui.UserDetails.UserDetailsActivity;
import com.mazad.mazadangy.gui.followAction.FollowActionActivity;
...
//import com.mazad.mazadangy.adapter.SliderAdapterExample;
...
//        sliderView.startAutoCycle();
        ...
        imageList = new ArrayList<String>();//(Collections.singleton(adsModel.imge.get(0).toString()));
        for (int i = 0; i < adsModel.imge.size(); i++) {

            imageList.add(adsModel.imge.get(i));
            System.out.println(i + " : " + imageList + "");
        }
        sliderPlace = findViewById(R.id.sliderPlace);
        if (!(imageList.size() == 0)) {
            sliderPlace.setSliderAdapter(new MySliderAdapter(this, imageList));
        ...
        tv_follow_comp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(PostDetailsActivity.this, FollowActionActivity.class);
                intent1.putExtra("id_Post", adsModel.id_post + "");
                intent1.putExtra("from_activity", fromActivity);
...
//
        ...
        layout_user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("UserModelPostDetailsActivity", userModel.uId + "");
                intent.putExtra("fromActivity", PostDetailsActivity.this + "");
...
//                                Map<String, String> mapsetData = new HashMap<>();
//                                mapsetData.put("end_price", final_price + "");
//                                mapsetData.put("uId", final_price + "");
//                                mapsetData.put("user_name", final_price + "");
//                                mapsetData.put("user_image", final_price + "");
//                                mapsetData.put("end_price", final_price + "");
//                                mapsetData.put("time", final_price + "");
//                                mapsetData.put("end_price", final_price + "");
//                                DR_setDataAution.setValue(mapsetData);
                                ...
                                DR_setEndPrice.child("end_price").setValue(final_price + "").addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {


                                            Toast.makeText(PostDetailsActivity.this, "تم التزويد", Toast.LENGTH_SHORT).show();
                                            tv_EndPrice.setText(final_price + "");
...
//                   }
    ...
    public void setValue(AdsModel adsModel, UserModel userModel) {
        ...
        tv_startPrice.setText(adsModel.start_price+" جنيه ");
        tv_EndPrice.setText(adsModel.end_price +" جنيه ");
