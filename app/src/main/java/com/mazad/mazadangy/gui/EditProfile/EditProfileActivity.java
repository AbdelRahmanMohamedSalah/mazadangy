...
public class EditProfileActivity extends AppCompatActivity {
    ...
    Button change;
    EditText etFirstName, etLastName, etNickName, etPhoneNumber, etInterest, Etoldpassword, Etnewpassword, Etconfirmpassword;
    TextView etEmail;
    Button BtnSave;
    UserModel userModel;
                ...
                if (textMatch()) {
                    ...
                    builder.setPositiveButton("تاكيد", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            result.put("email", userModel.getEmail().toString());
