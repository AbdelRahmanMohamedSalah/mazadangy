...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rgChoise();
        setDate();
        mUploadList = (RecyclerView) findViewById(R.id.mUploadListAddPostActivity);
        ...
        if (currentFirebaseUser == null) {
            ...
            addPost.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HelperMethods.showDialog(AddPostActivity.this, "من فضلك انتظر", "جاري التحميل ....");
...
//
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        HelperMethods.hideDialog(AddPostActivity.this);
                                        Intent intent = new Intent(AddPostActivity.this, CategoryActivity.class);
                                        startActivity(intent);
                                        finish();
                                        Toast.makeText(AddPostActivity.this, "م اضافه الاعلان بنجاح", Toast.LENGTH_SHORT).show();
                        ...
                        HelperMethods.hideDialog(AddPostActivity.this);
                        Toast.makeText(AddPostActivity.this, "برجاء ادخال جميع البيانات", Toast.LENGTH_SHORT).show();
    ...
    public void intilizeData() {
        ...
        adsImage = findViewById(R.id.imageAddPostActivity);
        ...
        minBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addmoneyNumber > 50) {
                    ...
                    Toast.makeText(AddPostActivity.this, "can,t decrease less 50 ", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                        Toast.makeText(AddAdsActivity.this, "12:00", Toast.LENGTH_SHORT).show();
        ...
        arrayList.add("سيارات");
        arrayList.add("اجهزة كهربائيه");
        arrayList.add("تحف و انتيكات");
        arrayList.add("اللكترونيات");
        arrayList.add("منشأت");
        arrayList.add("حيوانات اليفه");
